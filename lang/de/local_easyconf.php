...
$string['enabled'] = 'CLI-Ausführung erlauben';
$string['enabled_descr'] = 'Wenn ein regelmäßiger Cronjob die Ausführung des CLI-SKripts triggerd, kann dies verwendet werden, um sie zu (vorübergehend) deaktivieren.'; 
$string['enabled_text'] = 'CLI-Ausführungsmglichkeit des Plugins ist aktiviert.';
$string['disabled_text'] = 'CLI-Ausführungsmöglichkeit des Plugins ist deaktiviert.';
...
$string['configuration_error'] = 'Die Konfiguration ist fehlerhaft.';
...
$string['no_permission'] = 'Sie besitzen nicht die erforderlichen Ausführungsrechte. Ende.';
$string['easyconf:execute'] = 'Plugin auführen';

...
$string['execute'] = 'Run';
$string['enabled'] = 'Allow execution via CLI';
$string['enabled_descr'] = 'If a regular cronjob triggers the execution of the CLI script, this can be used to (temporarily) deactivate it.'; 
$string['enabled_text'] = 'Option to run plugin via CLI is enabled.';
$string['disabled_text'] = 'Option to run plugin via CLI is disabled.';
...
$string['configuration_error'] = 'Configuration has errors.';
...
$string['no_permission'] ='No permission to execute this plugin. Exiting.';
$string['easyconf:execute'] = 'Execute plugin';
